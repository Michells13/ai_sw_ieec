...
int main(void) 
{
    ...
    const char *MODEL_FILE =  "/home/pi/ai_sw/Risc-V/models/NoOptimized_MobileNet.tflite";    //model de la NN
    char directori[] = "/home/pi/ai_sw/Risc-V/images_224"; //CANVIAR pel path corresponent
